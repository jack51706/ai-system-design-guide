...
```mermaid
flowchart TD
    Start(["從這裡開始"]) --> Q1{"需要絕對的<br/>能力上限嗎？"}
    Q1 -->|"是"| R1["Claude Fable 5<br/>($10/$50, 1M)"]
    Q1 -->|"否"| Q2{"需要自主代理／<br/>長時程規劃嗎？"}
    Q2 -->|"是"| R2["Claude Opus 4.8<br/>GPT-5.5 reasoning"]
    Q2 -->|"否"| Q3{"需要最佳的軟體<br/>工程／編碼嗎？"}
    Q3 -->|"是"| R3["Fable 5 能力上限 /<br/>GPT-5.5 88.7% /<br/>Opus 4.8 88.6% /<br/>Sonnet 4.6 便宜"]
    Q3 -->|"否"| Q4{"需要處理<br/>巨量上下文 (>1M) 嗎？"}
    Q4 -->|"是"| R4["Gemini 3.0 Pro<br/>(2.5M 上下文)"]
    Q4 -->|"否"| Q5{"成本敏感的<br/>高流量嗎？"}
    Q5 -->|"是"| R5["Gemini 3 Flash /<br/>o4-mini"]
    Q5 -->|"否"| R6["預設：生產環境選擇<br/>Claude Sonnet 4.6 /<br/>GPT-5.5-mini"]
```
