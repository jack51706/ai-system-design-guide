...
本章提供一份截至 **2026 年 9 月** 的完整模型生態指南，涵蓋模型家族、能力，以及生產系統的選型準則。

> **最後驗證：2026 年 9 月 7 日。** 模型生態變動快速。請務必對照各供應商的價格頁面與發布說明再做交叉查核。
>
> **2026 年 9 月 1 日至 7 日更新：** Anthropic 於 9 月 1 日發布 **Claude Fable 5.1** 與限量存取的 **Claude Mythos 5.1**：每 token 定價與 Fable 5 相同，但快取讀取費用調降 75%（自每 1M $1.00 降至 $0.25），回報在 Terminal-Bench-Science 上取得 52.6% 的分數，生物安全防護機制對無害請求的誤攔截率已比 Fable 5 於 6 月推出時降低 85%，並新增可用於辨識原始碼中軟體漏洞的能力（來源：[Anthropic](https://www.anthropic.com/claude-fable-and-mythos-5-1)、[MarkTechPost](https://www.marktechpost.com/2026/09/01/anthropic-releases-claude-fable-5-1-and-claude-mythos-5-1-52-6-on-terminal-bench-science-and-75-cheaper-cache-reads/)、[MacRumors](https://www.macrumors.com/2026/09/01/anthropic-claude-fable-5-1/)）。OpenAI 於 9 月 3 日推出 **GPT-6 Astra**，是其 GPT-6 世代的首款模型，總裁 Greg Brockman 稱其標誌著「AGI 時代」的開端：每 1M token $10/$50（為 GPT-5.6 Sol 優惠價的 2.5 倍），OpenAI 回報的分數包括 FrontierMath Tier 4 的 98%、ARC-AGI-3 的 99.9%、ExploitBench 的 100%，以及 Terminal-Bench 4.0 的 57.9%（Sol 為 37.3%）；上市方式先開放給 OpenAI 的 Daybreak Access 計畫，數日後才擴及 ChatGPT Plus/Pro/Business/Enterprise，以及 API、Azure 與 AWS Bedrock（來源：[OpenAI](https://openai.com/index/gpt-6-astra/)、[VentureBeat](https://venturebeat.com/technology/welcome-to-the-agi-era-openai-launches-gpt-6-astra)、[Axios](https://www.axios.com/2026/09/03/openai-astra-gpt-6-agi-brockman)）。Meta 同週發布兩款較小型的產品：**Muse Voice Transcribe**（9 月 1 日），其首款即時語音感知模型，內建串流語音辨識、可辨識 20 位以上講者的分講者標記，以及語尾偵測，定價為每 1,000 分鐘 $3.00；以及 **Muse Spark 1.3**（9 月 2 日），Muse Spark 針對編碼／代理任務的更新版，維持先前每 1M $1.25/$4.25 的定價，不過 Meta 自行宣稱在編碼能力上勝過 GPT-5.6 Sol 一事尚未獲得獨立驗證（來源：[Meta 開發者部落格](https://developer.meta.com/ai/resources/blog/meet-muse-voice-transcribe-streaming-speech-to-text/)、[TechRepublic](https://www.techrepublic.com/article/news-meta-muse-voice-transcribe-real-time-speech/)、[TechRepublic](https://www.techrepublic.com/article/news-meta-muse-spark-1-3-ai-coding-2026/)）。xAI 本週沒有新品上市：Elon Musk 於 9 月 2 日宣布 **Grok 4.7**（2.1T 參數，較 Grok 4.6 的 1.5T 增加 40%，並將 SpaceX 工程紀錄與 Starlink 遙測資料納入訓練），目標於 9 月 12 日推出，但截至本文撰寫時，xAI 自家的開發者文件仍列出 Grok 4.6 為現行版本，尚未公布 Grok 4.7 的模型 ID、定價或基準測試卡，因此 9 月 12 日應視為目標日期，而非已上市的版本（來源：[BigGo Finance](https://finance.biggo.com/news/cdeb763e-3e82-4f0b-82bd-4f473881bf08)、[NextBigFuture](https://www.nextbigfuture.com/2026/09/spacexai-grok-4-7-releases-september-12.html)）。Google、DeepSeek、Alibaba/Qwen、Mistral、Moonshot、Z.ai 與 Cohere 在本週窗口內沒有新的、且來源紮實的消息；**Gemini 3.5 Pro** 仍未推出，也沒有新的日期。
>
